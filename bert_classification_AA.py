...
maxlen = 256
batch_size = 64
config_path = 'tk/config.json'
checkpoint_path = None
dict_path = 'tk/vocab_AA.txt'
...
# 加载数据集
train_dataloader = DataLoader(MyDataset(['tk/EC/EC_PDB_train.txt']), batch_size=batch_size, shuffle=True, collate_fn=collate_fn) 
valid_dataloader = DataLoader(MyDataset(['tk/EC/EC_PDB_valid.txt']), batch_size=batch_size, collate_fn=collate_fn) 
test_dataloader = DataLoader(MyDataset(['tk/EC/EC_PDB_test.txt']),  batch_size=batch_size, collate_fn=collate_fn) 
